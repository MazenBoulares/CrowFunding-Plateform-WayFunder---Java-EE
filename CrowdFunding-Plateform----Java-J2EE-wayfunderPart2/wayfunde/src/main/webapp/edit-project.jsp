...
<head>
   ...
   <!--   <link rel="stylesheet" href="../../index.css">-->
    ...
    <link rel="stylesheet" href="my-project/edit-project/index.css">
    <link rel="stylesheet" href="my-project/edit-project/css/main.css">    
</head>
<body>
    <nav >
            <div class="wrapper1">
                ...
                <div class="card-body" style="margin-top:40%;">
                    ...
                    <form method="GET" action="Controller">
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input autocomplete="off" class="input--style-4" type="text" name="goal" value="${budget}" >
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label   class="label">Launch Date</label>
                                    <input autocomplete="off" class="input--style-4" type="text" name="date" value="${date}" placeholder="dd/mm/yyyy">
                                </div>
                            </div>
                        ...
                        <div class="p-t-15">
                             ...
                             <button name="action" value="edit_project"  class="btn btn--radius-2 btn--blue" style="background-color: #22bc63;" type="submit">Edit Project</button>
                        </div>
                    </form>
                </div>
            </div>
